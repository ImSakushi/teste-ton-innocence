...
const Header: FC<HeaderProps> = ({ displayIntro = true }: HeaderProps) => {
    return (
        <header className="p-10">
            <h1 className="text-center text-4xl font-black text-white">Teste ton innocence</h1>
            ...
            {displayIntro && <p className="w-full sm:w-3/4 md:w-2/3 lg:w-1/2 xl:w-1/3 mx-auto my-5 text-neutral-700">
                ...
                et tout le monde peut l'ameliorer en contribuant sur <a href="https://github.com/ImSakushi/the-innocence-test-fr" target="_blank" className="underline hover:text-indigo-500">Github</a>.
            </p>}
        </header>
    );
};
